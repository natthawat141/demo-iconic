...
- Member chat handles general questions, ICONIC Knowledge questions, ambiguous questions, image input and CSV/XLSX analysis.
...
- Real authentication, SSO, organization membership, RBAC and an Admin authorization boundary. The demo uses a browser-scoped Demo User ID cookie only.
...
- Automated evaluation corpus, red-team prompts, human quality-review workflow and source freshness SLA for the assistant.
